...
class Waveform(DPT.DPObject):
	...
	def append(self, wf):
		...
		self.data = self.data + wf.data  # append self.setidx and self.dirs
	        # .........................................
	        # ..................code...................
	        # .........................................
	...
	def plot(self, i = None, ax = None, getNumEvents = False, getLevels = False, getPlotOpts = False, overlay = False, **kwargs):
		...
		plotOpts = {'PlotType': DPT.objects.ExclusiveOptions(['Channel', 'Array'], 0),'LabelsOff': False, 'TitleOff': False}
